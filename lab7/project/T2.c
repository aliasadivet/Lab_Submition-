...
int main(void)
{
    ...
    while(true)
    {
        ...
        while(!UARTCharsAvail(UART0_BASE));
        {
            ...
            switch(cmd)
            {
            case 'R' : { GPIOPinWrite(SYSCTL_PERIPH_GPIOF, GPIO_PIN_1, GPIO_PIN_1); break; }
            case 'G' : { GPIOPinWrite(SYSCTL_PERIPH_GPIOF, GPIO_PIN_2, GPIO_PIN_2); break; }
            case 'B' : { GPIOPinWrite(SYSCTL_PERIPH_GPIOF, GPIO_PIN_3, GPIO_PIN_3); break; }
